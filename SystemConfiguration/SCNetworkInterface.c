...
// Torrekie: Terrible wrapper
static SCNetworkInterfacePrivateRef __kSCNetworkInterfaceIPv4;
static SCNetworkInterfacePrivateRef __kSCNetworkInterfaceLoopback;

__attribute__((constructor))
static void init_priv_interface(void)
{
	__kSCNetworkInterfaceIPv4	= (SCNetworkInterfacePrivateRef)kSCNetworkInterfaceIPv4;
	__kSCNetworkInterfaceLoopback	= (SCNetworkInterfacePrivateRef)kSCNetworkInterfaceLoopback;
}
